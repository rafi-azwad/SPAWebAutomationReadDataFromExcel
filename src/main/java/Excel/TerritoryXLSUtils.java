...
public class TerritoryXLSUtils {
    public static List<String[]> readExcelData(String filePath) throws IOException {
        ...
        for (int i = 1; i < rowCount; i++) {
            ...
            if (row != null) {
                ...
                String address = row.getCell(2).getStringCellValue(); // Column 3
                String remark = row.getCell(3).getStringCellValue(); // Column 4


                dataList.add(new String[]{code, name, address, remark});
            }
        }
